...
class TestSession(TestCase):
    def setUp(self):
        User.objects.create_user(
            username="swerbernjagermanjensen",
    ...
    def test_valid_login(self):
        ...
        response = client.post(
            "/api/sessions",
            {"username": "swerbernjagermanjensen", "password": "hunter2"},
        )
    ...
    def test_invalid_login(self):
        ...
        response = client.post(
            "/api/sessions",
            {"username": "swerbernjagermanjensen", "password": "hunter43526"},
        )
...
class TestToDos(TestCase):
    ...
    def test_edit_todo(self):
        ...
        edit_response = client.put(
            "/api/todos/" + str(response.data["id"]) + "/",
